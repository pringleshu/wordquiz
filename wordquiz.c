...
void show_words ()
{
	...
	sprintf(filepath, "/Users/yunsihun/code/과제/wordbooks/%s", wordbook) ;
...
void run_test ()
{
	...
	while (line = read_a_line(fp)) {
		...
		printf("Q. %s (Enter 'h' for the hint)\n", meaning) ;
		printf("?  ") ;
		...
		else if(strcmp(answer, "h") == 0){ // hint
    printf("------------hint------------\n");
    printf("What kind of hint? \n");
    printf("1. The first letter of the word\n");
    printf("2. The number of letters\n");
    printf("3. Showing vowels\n");
    scanf("%d", &hint);
    switch (hint)
    {
        case 1:
